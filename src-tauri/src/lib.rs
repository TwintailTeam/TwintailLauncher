...
pub fn run() {
    ...
    let builder = {
        ...
        #[cfg(target_os = "windows")]
        {
            ...
            add_installed_runner, remove_installed_runner, get_installed_runner_by_version, get_installed_runner_by_id, list_installed_runners, update_installed_runner_install_status, is_steamrt_installed, check_network_connectivity, check_app_update])
