    ...
    return (
        <React.Fragment>
            <div className={`w-full bg-neutral-800 h-14 flex flex-row items-center justify-between p-4 ${roundTop ? "rounded-t-lg" : ""} ${roundBottom && isFolded ? "rounded-b-lg" : ""}`}>
                ...
                <ChevronDown color="white" onClick={() => setIsFolded(!isFolded)}
            ...
            <div className={`w-full transition-all duration-500 overflow-hidden bg-neutral-900 gap-4 flex flex-col items-center justify-between px-4 ${isFolded ? "py-0" : "py-4"} ${roundBottom ? "rounded-b-lg" : ""}`}
