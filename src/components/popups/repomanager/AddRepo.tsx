...
export default function AddRepo({setOpenPopup}: {setOpenPopup: (popup: POPUPS) => void}) {
    ...
    return (
        <div className="rounded-lg h-auto w-1/2 bg-black/70 border border-white/20 flex flex-col p-6 gap-4 overflow-scroll scrollbar-none">
            ...
            <input type="text"
                   className="focus:outline-none h-12 rounded-lg bg-black/70 border border-white/20 text-white px-4 placeholder-white/50 text-lg"
