                                    ...
                                    {gameBiz && (gameBiz.startsWith("hk4e") || gameBiz.startsWith("hkrpg") || gameBiz.startsWith("nap") || gameBiz.startsWith("bh3") || gameBiz.startsWith("abc") || gameBiz.startsWith("hyg")) && (
                                        <button
                                            ...
                                            <div className="flex flex-col">
                                                ...
                                                <span className={`text-xs ${isAuthkeyCopied ? "text-emerald-300" : isAuthkeyFailed ? "text-red-300" : "text-zinc-400"}`}>{isAuthkeyCopying ? translate("game_settings.manage.copy_authkey.copying_description") : isAuthkeyCopied ? translate("game_settings.manage.copy_authkey.copied_description") : isAuthkeyFailed ? translate("game_settings.manage.copy_authkey.failed_description") : <>Sync and view your pull history at <span className="text-purple-400">aivo.minlor.net/hoyo</span></>}</span>
                                            </div>
                                        </button>
                                    )}
