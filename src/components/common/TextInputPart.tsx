        ...
        return (
            <div className="w-full" style={this.props.style || {}}>
                <input id={this.props?.id}
                    ...
                    className={`text-ellipsis w-full focus:outline-none h-10 rounded-xl bg-black/40 border border-white/20 text-white px-3 placeholder-white/50 focus:border-white/40 transition-colors ${this.props.isPicker ? "cursor-pointer" : ""}`}
